...
<link rel="stylesheet" href="WebContent/resource/css/theme_customize.css">
</head>
<body>
			...
			<div class="row">
				...
				<div class="col-md-9 custom_background_color panel-group">
					...
					<div class="panel panel-default panel-content">
						<a href="#"> <b>Ruby on Rails Developer ($1000 - $1,500)</b>
						</a>
						<div class="row" style="margin-left: 30px;">
							<div class="row">
								<p>Free Range Technology</p>
							</div>
							<div class="row">
								<p>Salary: 1,000 - 1,500 USD</p>
							</div>
							<div class="row">
								<p>We are looking for a talented Ruby on Rails Developer who wants to work with new
									Developers in an interactive working Environment. If you are young,...</p>
							</div>
						</div>
						<div class="panel-footer">
							<a href="#" class="btn btn-default glyphicon glyphicon-thumbs-up"></a> <a href="#"
